...
class day3 extends JFrame implements ActionListener {
    JLabel label;
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == b1) {   // Every time Next button is pressed count is updated. Based on this count we know which quesiton to display next
            if (check())
                count = count + 1;
            current++;
            set();
